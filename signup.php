...
$numsa = mysql_num_rows($query_sa);
$maapplied = false;
if($numsa > 0) {
	$query_ma = mysql_query("SELECT Username FROM multiaccount_data WHERE IP = '$_SERVER[REMOTE_ADDR]'",$DB);
	$maapplied = (mysql_num_rows($query_ma) > 0);
}
?>
